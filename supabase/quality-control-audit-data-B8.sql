...
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Saloon','Moegamat Saleem Philander',0) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Stbd Fwd Cabin','',1) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Stbd Fwd Heads','',2) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Stb Pessage','Moegamat Saleem Philander',3) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Stbd Aft Heads','',4) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Stbd Aft Cabin','Moegamat Saleem Philander',5) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Port Fwd Cabin','',6) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Port Fwd Heads','',7) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Port Passage','',8) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Port Aft Heads','',9) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Port Aft Cabin','Moegamat Saleem Philander',10) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Aft Cockpit','Imran Majiet',11) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Flybridge','Zunaid Hoosen',12) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Fwd Cockpit & Foredeck','Zunaid Hoosen',13) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Stb Deck','Zunaid Hoosen',14) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8126','Port Deck','Zunaid Hoosen',15) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
...
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Port Hull','Sheldon Barends',0) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Stbd Hull','Sheldon Barends',1) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Aft Cockpit','',2) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Stbd Side Deck','',3) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Port Side Deck','',4) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Flybridge','',5) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Forward Cockpit','Sheldon Barends',6) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Saloon','',7) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Stbd Aft Cabin','',8) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Stbd Aft Heads','',9) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Stbd Fwd Heads','',10) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Stbd Fwd Cabin','Sheldon Barends',11) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Port Aft Heads','',12) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Port Aft Cabin','',13) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Port Passage','',14) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Port Fwd Heads','',15) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8127','Port Fwd Cabin','Sheldon Barends',16) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_defects (id,boat_id,area_name,item,failure_mode,description,code,discipline,concern,repaired_by,repaired_date,team_leader_check,qc_rwk,qc_acc) values
...
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Aft Cockpit','Sheldon Barends',0) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Saloon','Sheldon Barends',1) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Stbd Fwd Heads','',2) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Stbd Study & Passage','Sheldon Barends',3) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Port Fwd Cabin','',4) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Port Fwd Heads','',5) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Port Passage','Sheldon Barends',6) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Port Aft Cabin','',7) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Port Aft Heads','Sheldon Barends',8) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Flybridge','',9) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Port Side Deck','',10) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Stbd Side Deck','Imran Majiet',11) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Fwd Cockpit & Foredeck','',12) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Stbd Hull','',13) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8129','Port Hull','Imran Majiet',14) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_defects (id,boat_id,area_name,item,failure_mode,description,code,discipline,concern,repaired_by,repaired_date,team_leader_check,qc_rwk,qc_acc) values
...
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Stbd Hull','',0) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Port Hull','Sheldon Barends',1) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Aft Cockpit','',2) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Port Side Deck','',3) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Fwd Cockpit & Foredeck','',4) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Stbd Side Deck','Sheldon Barends',5) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Flybridge','Sheldon Barends',6) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Saloon','Sheldon Barends',7) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Forepeak','',8) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Port Fwd Cabin','',9) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Port Fwd Heads','',10) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Port Passage','Sheldon Barends',11) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Port Aft Heads','',12) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Port Aft Cabin','Sheldon Barends',13) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Stbd Fwd Cabin','',14) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Stbd Fwd Heads','',15) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Stbd Aft Heads','',16) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b8130','Stbd Aft Cabin','Sheldon Barends',17) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_defects (id,boat_id,area_name,item,failure_mode,description,code,discipline,concern,repaired_by,repaired_date,team_leader_check,qc_rwk,qc_acc) values
