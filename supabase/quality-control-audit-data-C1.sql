...
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1068','Port Aft Cabin',0) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1068','Port Aft Heads',1) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1068','Port Passage',2) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1068','Port Fwd Cabin',3) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1068','Forepeak',4) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1068','Port Fwd Heads',5) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1068','Study',6) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1068','Stbd Aft Cabin',7) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1068','Stbd Fwd Heads',8) on conflict (boat_id,area_name) do nothing;
...
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Saloon',0) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Stbd Fwd Heads',1) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Stbd Fwd Cabin',2) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Stbd Passage',3) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Stbd Aft Heads',4) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Study',5) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Stbd Aft Cabin',6) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Port Fwd Cabin',7) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Port Fwd Heads',8) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Port Aft Cabin',9) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Port Aft Heads',10) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Port Passage',11) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Aft Cockpit',12) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Port Side Deck',13) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Stbd Side Deck',14) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Flybridge',15) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Fwd Cockpit & Foredeck',16) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Port Hull',17) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1069','Stbd Hull',18) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_defects (id,boat_id,area_name,item,failure_mode,description,code,discipline,concern,repaired_by,repaired_date,team_leader_check,qc_rwk,qc_acc) values
...
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Saloon',0) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Stbd Fwd Heads',1) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Stbd Fwd Cabin',2) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Stbd Passage',3) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Stbd Aft Heads',4) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Study',5) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Stbd Aft Cabin',6) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Port Fwd Cabin',7) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Port Fwd Heads',8) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Port Passage',9) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Port Aft Heads',10) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Port Aft Cabin',11) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Stbd Side Deck',12) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Port Side Deck',13) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Fwd Cockpit & Foredeck',14) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Aft Cockpit',15) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Stbd Hull',16) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Port Hull',17) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1070','Flybrige',18) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_defects (id,boat_id,area_name,item,failure_mode,description,code,discipline,concern,repaired_by,repaired_date,team_leader_check,qc_rwk,qc_acc) values
...
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Port Deck',0) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Stb Deck',1) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Fwd Cockpit & Foredeck',2) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Flybridge',3) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Port Hull',4) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Stbd Hull',5) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Aft Cockpit',6) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Saloon',7) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Port Fwd Cabin',8) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Port Fwd Heads',9) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Port Passage',10) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Port Aft Heads',11) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Port Aft Cabin',12) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Stbd Fwd Heads',13) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Stbd Fwd Cabin',14) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Stbd Passage',15) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1071','Study',16) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_defects (id,boat_id,area_name,item,failure_mode,description,code,discipline,concern,repaired_by,repaired_date,team_leader_check,qc_rwk,qc_acc) values
...
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Stbd Fwd Heads',0) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Stbd Passage',1) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Stbd Aft Heads',2) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Study',3) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Stbd Aft Cabin',4) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Aft Cockpit',5) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Port Deck',6) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Stb Deck',7) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Fwd Cockpit & Foredeck',8) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Flybribge',9) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Port Hull',10) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Stbd Hull',11) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Saloon',12) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Port Fwd Cabin',13) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Port Fwd Heads',14) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Port Passage',15) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Port Aft Heads',16) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_areas (boat_id,area_name,sort_order) values ('qc-handover-c1072','Port Aft Cabin',17) on conflict (boat_id,area_name) do nothing;
insert into public.quality_control_defects (id,boat_id,area_name,item,failure_mode,description,code,discipline,concern,repaired_by,repaired_date,team_leader_check,qc_rwk,qc_acc) values
