...
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9074','Owner''S Heads','',0) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9074','Study','',1) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9074','Stbd Aft Cabin','Moegamat Saleem Philander',2) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9074','Aft Cockpit','',3) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9074','Fwd Cockpit & Foredeck','',4) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9074','Flybridge','Moegamat Saleem Philander',5) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9074','Stbd Hull','Moegamat Saleem Philander',6) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9074','Port Fwd Cabin','Zunaid Hoosen',7) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
...
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9074','Port Passage','',9) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9074','Port Deck','',10) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9074','Stb Deck','Zunaid Hoosen',11) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9074','Saloon','',12) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
...
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9075','Saloon','Zunaid Hoosen',0) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9075','Aftcockpit','Zunaid Hoosen',1) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9075','Stbd Fwd Heads','',2) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9075','Study','',3) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9075','Stbd Aft Cabin','Imran Majiet',4) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9075','Port Fwd Cabin','',5) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9075','Port Heads','',6) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9075','Port Aft Cabin','',7) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9075','Fwd Cockpit & Foredeck','',8) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9075','Stbd Side Deck','',9) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9075','Port Side Deck','',10) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_defects (id,boat_id,area_name,item,failure_mode,description,code,discipline,concern,repaired_by,repaired_date,team_leader_check,qc_rwk,qc_acc) values
...
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9076','Saloon','Sheldon Barends',0) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9076','Stbd Fwd Heads','',1) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
...
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9076','Aft Cockpit','Sheldon Barends',3) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9076','Stbd Hull','',4) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9076','Port Hull','Sheldon Barends',5) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9076','Forward Cockpit','',6) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9076','Stbd Side Deck','',7) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9076','Port Side Deck','',8) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9076','Flybridge','Sheldon Barends',9) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9076','Port Fwd Cabin','',10) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9076','Port Passage','Zunaid Hoosen',11) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9076','Port Heds','',12) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9076','Port Aft Cabin','Zunaid Hoosen',13) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_defects (id,boat_id,area_name,item,failure_mode,description,code,discipline,concern,repaired_by,repaired_date,team_leader_check,qc_rwk,qc_acc) values
...
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Port Fwd Cabin','',0) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Port Fwd Heads','',1) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Port Passage','Sheldon Barends',2) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Port Aft Cabin','Sheldon Barends',3) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Owner''S Heads','',4) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Stbd Owner''S Cabin','Sheldon Barends',5) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Saloon','Sheldon Barends',6) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Aft Cockpit','Sheldon Barends',7) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Flybridge','',8) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Port Side Deck','',9) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Stbd Side Deck','',10) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Fwd Cockpit & Foredeck','',11) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Stbd Hull','',12) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9077','Port Hull','Sheldon Barends',13) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_defects (id,boat_id,area_name,item,failure_mode,description,code,discipline,concern,repaired_by,repaired_date,team_leader_check,qc_rwk,qc_acc) values
...
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9078','Aft Cockpit','',0) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9078','Port Side Deck','',1) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9078','Stbd Side Deck','',2) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9078','Flybridge','Imran Majiet',3) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9078','Fwd Cockpit & Foredeck','',4) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9078','Stbd Hull','Imran Majiet',5) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9078','Port Aft Cabin','Moegamat Saleem Philander',6) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9078','Port Heads','',7) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9078','Port Passage','',8) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9078','Stbd Study & Passage','',9) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_areas (boat_id,area_name,inspector,sort_order) values ('qc-handover-b9078','Stbd Aft Cabin','Moegamat Saleem Philander',10) on conflict (boat_id,area_name) do update set inspector=case when coalesce(trim(quality_control_areas.inspector),'')='' then excluded.inspector else quality_control_areas.inspector end;
insert into public.quality_control_defects (id,boat_id,area_name,item,failure_mode,description,code,discipline,concern,repaired_by,repaired_date,team_leader_check,qc_rwk,qc_acc) values
