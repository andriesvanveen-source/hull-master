...
export async function exportBoatReport(boat, options = {}) {
  ...
  areas.forEach((area) => {
    ...
    defects.forEach((defect) => {
      ...
      if (defect.callbackRequestedAt) {
        tableRows.push([
          { content: "", styles: { fillColor: [255, 238, 235] } },
          { content: `CALLBACK · Raised ${defect.callbackRequestedAt}`, styles: { fillColor: [255, 238, 235], fontStyle: "bold", textColor: [150, 44, 32] } },
          { content: "", styles: { fillColor: [255, 238, 235] } },
          { content: "Re-sign", styles: { fillColor: [255, 238, 235], fontStyle: "italic" } },
          { content: "", styles: { fillColor: [255, 238, 235] } },
          { content: "", styles: { fillColor: [255, 238, 235] } },
          { content: "", styles: { fillColor: [255, 238, 235] } }
        ]);
