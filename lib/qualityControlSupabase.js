...
const BOAT_SELECT = "id,name,model,created_at,updated_at,quality_control_areas(area_name,inspector,sort_order),quality_control_defects(id,area_name,item,failure_mode,description,code,discipline,concern,repaired_by,repaired_date,team_leader_check,qc_rwk,qc_acc,created_at,updated_at)";
